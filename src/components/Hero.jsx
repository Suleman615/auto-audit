...
const Hero = () => {
    return (
        <div className="flex flex-col   md:flex-row items-center justify-between gap-10 px-6 lg:px-10 py-16 text-white">
            {/* Left Form Content */}
            <div className="w-full lg:w-1/2">
                ...
                <form className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        className="p-3 text-base border border-gray-500 rounded-xl ring-2 ring-black focus:ring-cyan-400 focus:border-cyan-400 outline-0"
                    />
